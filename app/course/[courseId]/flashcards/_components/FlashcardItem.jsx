...
const FlashcardItem = ({isFlipped, handleClick , flashcard}) => {
  return (
    <ReactCardFlip isFlipped={isFlipped} flipDirection="vertical">
        ...
        <div className='p-4 bg-white text-blue-700 flex items-center justify-center rounded-lg cursor-pointer h-[250px] w-[200px] md:h-[350px] md:w-[300px] shadow-2xl' onClick={handleClick}>
