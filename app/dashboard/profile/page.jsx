        ...
        <div className='p-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-10'>
                ...
                <div className='bg-white shadow-md rounded-xl p-8 flex flex-col justify-center items-center border'>
                    ...
                    <h2 className='text-gray-500 text-sm flex items-center gap-2 mt-2'>
                ...
                <div className='col-span-2 bg-white shadow-md rounded-xl p-8 border'>
                    <h2 className='font-bold text-xl mb-6'>Account Details</h2>
                    ...
                    <div className='mt-8 p-4 bg-blue-50 border border-blue-100 rounded-lg flex items-center gap-4'>
                        <div className='p-3 bg-blue-100 rounded-full'>
                            <Crown className='h-6 w-6 text-blue-600'/>
                        </div>
                        <div>
                            <h2 className='font-bold text-blue-700'>Upgrade Plan</h2>
                            <p className='text-blue-600 text-sm'>Unlock premium features and unlimited courses</p>
                        </div>
                    </div>
                </div>
            </div>
